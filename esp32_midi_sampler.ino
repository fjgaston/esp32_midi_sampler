...
void setup()
{
  ...
  */
  ...
  Sampler_LoadPatchFile("/samples/8k.wav");
#endif

  /* select sd card */
#ifdef AUTO_LOAD_PATCHES_FROM_SD_MMC
  PatchManager_SetDestination(1, 1);
  Sampler_LoadPatchFile("/samples/1a.wav");
  Sampler_NoteOn(1,8,1);
  Sampler_NoteOff(1,8);
  
  sampleRecordCount--;
  Sampler_AddSection(64, 0, 213444, 6644, 140912, "1a");
  
  //Sampler_LoadPatchFile("/samples/C2.wav");
#endif
